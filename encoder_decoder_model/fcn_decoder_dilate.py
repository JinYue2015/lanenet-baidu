...
class FCNDecoder(cnn_basenet.CNNBaseModel):
    ...
    def decode(self, input_tensor_dict, decode_layer_list, name):
        ...
        with tf.variable_scope(name):
            ...
            score_pool5 = self.conv2d(inputdata=input_tensor, out_channel=64,
                                kernel_size=1, use_bias=False, name='score_pool5')
            ...
            score = self.conv2d(inputdata=concated, out_channel=64, 
